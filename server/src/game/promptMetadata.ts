...
const FAMILY_PATTERNS: ReadonlyArray<readonly [PromptFamily, RegExp]> = [
  ...
  ["travel-driving", /سفر|رحلة|مطار|سيار|تسوق|الطريق|طريق|خرائط|موقف|ركنت|زحمة|شاليه|مدينة|مكان جديد|الشباك/iu],
  ["shopping-money", /اشتريت|شريت|شراء|خصم|سلة|عرض|هدية|كراتين/iu],
