...
const ALLOWED_KEYS: Record<AnalyticsEvent, readonly string[]> = {
  ...
  game_started: [
    "roomSessionId", "matchId", "matchOrdinal", "isFirstMatch", "targetChallenges", "startingPlayerCount",
    "modeCount", "modeSet", "rulesVersion", "contentVersion",
  ],
  challenge_completed: [
    "roomSessionId", "matchId", "matchOrdinal", "targetChallenges", "challengeOrdinal", "challengeWithinStint",
    "stintOrdinal", "stintMaxChallenges", "participantCount", "mode", "promptId", "caught", "stintComplete",
    "impostorVotes", "requiredVotes", "topNormalVotes", "distinctTargets", "voteMargin", "allNormalsVotedImpostor",
    "readySeconds", "discussionSeconds", "votingSeconds", "challengeSeconds", "rulesVersion", "contentVersion",
  ],
  game_completed: [
    "roomSessionId", "matchId", "matchOrdinal", "isFirstMatch", "targetChallenges", "completedChallenges",
    "startingPlayerCount", "endingPlayerCount", "durationSeconds", "impostorStints", "caughtStints",
    "topScore", "averageScore", "scoreSpread", "rulesVersion", "contentVersion",
  ],
  game_abandoned: [
    "roomSessionId", "matchId", "matchOrdinal", "targetChallenges", "completedChallenges", "startingPlayerCount", "reason", "phase",
  ],
  ...
  feedback_rating: [
    "roomSessionId", "matchId", "matchOrdinal", "rating", "targetChallenges", "completedChallenges",
    "startingPlayerCount", "scoreBucket", "rankBucket", "rulesVersion", "contentVersion",
  ],
  feedback_challenge_issue: [
    "roomSessionId", "matchId", "matchOrdinal", "challengeOrdinal", "challengeWithinStint", "promptId", "mode", "reason",
    "targetChallenges", "startingPlayerCount", "rulesVersion", "contentVersion",
  ],
  client_started: [
    "deviceClass", "viewportBucket", "browserFamily", "osFamily", "displayMode", "languageGroup", "touch",
    "connectionType", "saveData", "reducedMotion", "hardwareConcurrencyBucket", "deviceMemoryBucket", "pixelRatioBucket",
    "orientation", "audioContext", "vibration", "share", "intlSegmenter", "visualViewport", "networkInfo", "routeBucket",
  ],
  client_performance: [
    "navigationType", "domContentLoadedMs", "loadMs", "fcpMs", "ttfbMs", "resourceCount", "transferKb", "routeBucket",
  ],
  client_vital: ["metric", "value", "rating", "routeBucket"],
  client_session_summary: [
    "lifetimeSeconds", "foregroundSeconds", "backgroundTransitions", "offlineTransitions", "onlineTransitions",
    "resizeEvents", "orientationChanges", "routeBucket",
  ],
