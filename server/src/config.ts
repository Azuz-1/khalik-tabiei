...
export function readConfig(env: NodeJS.ProcessEnv = process.env) {
  ...
  return {
    ...
    abuseLimits: {
      ...
      displayPairingCreateIp: limitRule(env, "RATE_LIMIT_DISPLAY_PAIRING_CREATE_IP", DEFAULT_ABUSE_LIMITS.displayPairingCreateIp),
      displayPairingClaimIp: limitRule(env, "RATE_LIMIT_DISPLAY_PAIRING_CLAIM_IP", DEFAULT_ABUSE_LIMITS.displayPairingClaimIp),
      displayPairingClaimIdentity: limitRule(env, "RATE_LIMIT_DISPLAY_PAIRING_CLAIM_IDENTITY", DEFAULT_ABUSE_LIMITS.displayPairingClaimIdentity),
      displayPairingStatusIp: limitRule(env, "RATE_LIMIT_DISPLAY_PAIRING_STATUS_IP", DEFAULT_ABUSE_LIMITS.displayPairingStatusIp),
      displayPairingStatusPairing: limitRule(env, "RATE_LIMIT_DISPLAY_PAIRING_STATUS_PAIRING", DEFAULT_ABUSE_LIMITS.displayPairingStatusPairing),
